  ...
  return (
    <div className="flex items-center gap-2">
      <button 
        ...
        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-white/50 text-[13px] text-foreground hover:border-white hover:text-foreground transition-all cursor-pointer bg-transparent"
      >
        <svg
          width="14"
          height="14"
