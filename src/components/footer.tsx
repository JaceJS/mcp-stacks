      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <Link
              href="/explore"
              className="text-[13px] text-[var(--foreground-subtle)] hover:text-[var(--foreground-muted)] transition-colors"
            >
              Browse
            </Link>
            <Link
            ...
            <a
              href="https://github.com/jace/mcpstacks"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[13px] text-[var(--foreground-subtle)] hover:text-[var(--foreground-muted)] transition-colors inline-flex items-center gap-1.5"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-[11px] text-[var(--foreground-subtle)] hover:text-[var(--accent)] transition-colors"
              style={{ fontFamily: "var(--font-code)" }}
            >
