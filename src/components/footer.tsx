      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-[13px] text-muted">MCP Stacks</span>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[13px] text-subtle transition-colors hover:text-muted"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 font-mono text-[11px] text-subtle transition-colors hover:text-accent"
            >
