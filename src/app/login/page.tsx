        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <form className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl bg-white text-background font-medium text-[14px] hover:bg-gray-100 transition-colors cursor-pointer border-none"
            >
              <svg
                width="20"
                height="20"
